...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabSystem = __webpack_require__(160);
	var TabSystem2 = __webpack_require__(161);
	  ...
	  render:function () {
	    return (
	      React.createElement("div", null, 
	        ...
	        React.createElement(TabSystem, {tabs:  tabs }), 
	        React.createElement(TabSystem2, null)
	      )
	    )
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = __webpack_require__(159);

	var List = React.createClass({displayName: "List",

	  render:function () {
	    var items = this.props.items.map(function(item)  {
	      return React.createElement(Item, {key: item, val: item});
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabSystem = React.createClass({displayName: "TabSystem",
	  ...
	  renderTabs:function () {
	    return this.props.tabs.map(function(tab, index)  {
	      ...
	      return (
	        React.createElement("div", {className: "tab", key: tab.name, onClick: clickHandler}, 
	          tab.name
	        )
	      );
	    }.bind(this));
	  ...
	  render:function () {
	    return (
	      React.createElement("div", null, 
	        React.createElement("h1", null, "TAB SYSTEM "), 
	        React.createElement("div", null, 
	           this.renderTabs() 
	        ), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabSystem2 = React.createClass({displayName: "TabSystem2",
	  ...
	  render:function () {
	    return (
	      React.createElement("div", null, 
	        React.createElement("h1", null, "TAB SYSTEM 2"), 
	        React.createElement(Tabs, {tabs: tabs2, currentTab: this.state.currentTab, handleClick: this.handleClick}), 
	        React.createElement("hr", null)
	      )
	    )
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tab = __webpack_require__(163);
	...
	var Tabs = React.createClass({displayName: "Tabs",
	  ...
	  renderTabs:function () {
	    return this.props.tabs.map(function(tab, index)  {
	      ...
	      return (
	        React.createElement(Tab, {key: tab.name, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tab = React.createClass({displayName: "Tab",
	  ...
	  render:function () {
	    ...
	    return (
	      React.createElement("span", {className: this.props.className, onClick: this.props.handleClick}, 
	        this.props.name
	      )
	    )
	  }
